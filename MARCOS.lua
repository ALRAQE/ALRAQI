...
if text == 'تفعيل التواصل h🔛' and SudoBot(msg) then  
...
if text == 'تفعيل البوت الخgدمي 🔓' and SudoBot(msg) then  
if database:get(bot_id..'Free:Bots') then
database:del(bot_id..'Free:Bots') 
Text = '\n🔘| تم تفعيل البgوت الخدمي ' 
else
Text = '\n⚠️| بالتاكيد تم تفعيل البوت الخدمي '
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل البوت الخدgمي 🔏' and SudoBot(msg) then  
...
if text == 'ضع كليشه سhتارت 📃' and SudoBot(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,'📑| ارسل لي الكليشه الان') 
return false
end
if text == 'حذف كليشه gستارت ♻️' and SudoBot(msg) then 
...
if text == 'معلومات الكيبوgرد 💬' and SudoBot(msg) then 
...
if text == "ضع اسم للبgوت ®" and SudoBot(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_,"📫¦ ارسل لي الاسم الان ")  
return false
end
if text == 'الاحصائياgت 🔍' and SudoBot(msg) then 
...
if text == ("المطوريgن 👷‍♂️") and SudoBot(msg) then
...
if text == ("قائمه العgام 📝") and SudoBot(msg) then
...
if text=="اذاعه خاhص 🗣️" and msg.reply_to_message_id_ == 0 and SudoBot(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"📥¦ ارسل لي سواء >> { ملصق, متحركه, صوره, رساله }\n📫¦ للخروج ارسل الغاء ") 
return false
end 
if text=="اذاعه قروباgت👥" and msg.reply_to_message_id_ == 0 and SudoBot(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"📥¦ ارسل لي سواء >> { ملصق, متحركه, صوره, رساله }\n📫¦ للخروج ارسل الغاء ") 
return false
end  
if text=="اذاعه بالتوجgيه 🔖" and msg.reply_to_message_id_ == 0  and SudoBot(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"📥| ارسل لي التوجيه الان") 
return false
end 
if text=="اذاعه بالتوجيه gخاص 📯" and msg.reply_to_message_id_ == 0  and SudoBot(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"📥| ارسل لي التوجيه الان") 
return false
end 
if text=="اذاعه بالتgثبيت" and msg.reply_to_message_id_ == 0 and SudoBot(msg) then 
...
if text == "تنظيف المشتركيgن 🗑️" and SudoBot(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفعد مطيهث h@h(.*)$") and SudoBot(msg) then
local username = text:match("^رفع مطhور @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفعد مطيهث (%d+)$") and SudoBot(msg) then
local userid = text:match("^رفعد مطيهث (%d+)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيد مطيهث @(.*)$") and SudoBot(msg) then
local username = text:match("^تنزيد مطيهث @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيد مطيهث (%d+)$") and SudoBot(msg) then
local userid = text:match("^تنزيد مطيهث (%d+)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chhat_id_, msg.id_,'🔖¦ عدد اعضاء المجموعه قليله يرجى جمع >> {'..(database:get(bot_id..'Num:Add:Bot') or 0)..'} عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chtat_id_, msg.id_,'*🔖┇ يا عيني مفعل من زمان لا تزعجنا ♥️*')
else
sendText(msg.chtat_id_,'\n👤| بواسطه ← ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n📝|  تم تفعيل المجموعه {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
send(msg.chagt_id_, msg.id_,'🔖¦ المجموعه تم تطيلها من قبل')
else
sendText(msg.chgat_id_,'\n👤| بواسطه ← ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n📌| تم تعطيل المجموعه {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
if text and text:match("^ضع عدد الاعضاءالُنَ (%d+)$") and SudoBot(msg) then
local Num = text:match("ضع عدد الاعضاء لُلُاتْ(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تغير الاشتhراك$") and SudoBot(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '⚡| حسنآ ارسل لي معرف القناة') 
return false  
end
if text and text:match("^تغير رساله اhلاشتراك$") and SudoBot(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '📌| حسنآ ارسل لي النص الذي تريده') 
return false  
end
if text == "حذف رساله الاgشتراك 🚫" and SudoBot(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, "🔘| تم مسح رساله الاشتراك ") 
return false  
end
if text and text:match("^تفعيل الاشتراكg الاول🌟$") and SudoBot(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '🔰| حسنآ ارسل لي معرف القناة') 
return false  
end
if text == "تفعيل الاشتراك الاhجباري 📥" and SudoBot(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجبgاري 📤" and SudoBot(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, "🔖| تم تعطيل الاشتراك الاجباري ") 
return false  
end
if text == "الاشتراك الاجبارgي 🚸" and SudoBot(msg) then  
...
usertext = '\n👤| العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ASTORHBOTS')..')'
status  = '\n🔘| تم الغاء(الكتم) عام من القروبات  '
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
if text and text:match("^الغاء الكتم العام @(.*)$") and SudoBot(msg) then
local username = text:match("^الغاء الكتم العام @(.*)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء الكتم العام (%d+)$") and SudoBot(msg) then
local userid = text:match("^الغاء الكتم العام (%d+)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
------------------------------------------------------------
if text and text:match("^اضف رسائلاا (%d+)$") and msg.reply_to_message_id_ == 0 and Constructor(msg) then    
taha = text:match("^اضف رسائااتتل (%d+)$")
...
------------------------------------------------------------------------
if text and text:match("^اضاااااف نقاط (%d+)$") and msg.reply_to_message_id_ == 0 and Constructor(msg) then  
...
------------------------------------------------------------------------
if text and text:match("^اضف اااانقاط (%d+)$") and msg.reply_to_message_id_ ~= 0 and Constructor(msg) then
local Num = text:match("^اضفااااا نقاط (%d+)$")
...
------------------------------------------------------------------------
if text and text:match("^اضف رساتتاائل (%d+)$") and msg.reply_to_message_id_ ~= 0 and Constructor(msg) then
local Num = text:match("^اضف رسائااااال (%d+)$")
function reply(extra, result, success)
